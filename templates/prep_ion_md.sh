...
cp -r $(echo '$PBS_O_WORKDIR')/qcxms.gs $(echo '$SCRATCHDIR') 
cp -r $(echo '$PBS_O_WORKDIR')/qcxms.in $(echo '$SCRATCHDIR') 
...
chmod +x ${molname}_prep.pbs
qsub ${molname}_prep.pbs